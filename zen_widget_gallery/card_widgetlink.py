...
class CardWidgetLinkColorData(ZColorData):
    Body: QColor
    Border: QColor
...
@colordata_provider(datamap=colordata, classtype=CardWidgetLinkColorData)
class CardWidgetLink(ZClickWidget[ZButtonStyle]):
    bodyColorCtrl: ZAnimatedColor
    borderColorCtrl: ZAnimatedColor
    colorDataCtrl: ZColorController[CardWidgetLinkColorData]
    __controllers_kwargs__ = {
        'colorDataCtrl':{'key': 'CardWidgetLink'}
    }
    ...
    def __init__(self,
        ...
        layout = ZHBoxLayout(self, margins=QMargins(24, 16, 16, 16), spacing=16)
    ...
    def _init_color_data_(self):
        ...
        self.bodyColorCtrl.setAlphaF(0.7)
    ...
    def _color_data_change_handler_(self):
        ...
        self.bodyColorCtrl.setColor(data.Body)
        self.bodyColorCtrl.setAlphaFTo(0.7)
